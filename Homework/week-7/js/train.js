...
firebaseRef.on("child_added", snap => {
	...
	$("#train-timetable").append("<tr><td>" + trainName + "</td><td>" + trainDestination + "</td><td>Every " + trainFrequency + " minutes</td><td>" + trainFirst + "</td><td>" + moment().format('LT') + "</td><td><button type='button' class='btn btn-danger'>Cancel Train</button></td></tr>")
});
